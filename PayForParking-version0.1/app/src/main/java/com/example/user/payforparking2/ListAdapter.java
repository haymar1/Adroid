...
public class ListAdapter extends ArrayAdapter<Customer> {
    ...
    public class ViewHolder {
        ...
        TextView Name;
        TextView Plate;
        TextView Color,Date,Time,Flage;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.Plate = (TextView) convertView.findViewById(R.id.textviewPlateNumber);
            holder.Color = (TextView) convertView.findViewById(R.id.textviewColor);
            ...
            // holder.Flage = (TextView) convertView.findViewById(R.id.textviewflage);
        ...
        holder.Plate.setText(student.getPlatenumber());

        holder.Color.setText(student.getColor());

        holder.Date.setText(student.getDate());

        holder.Time.setText(student.getTime());
        // holder.Flage.setText(student.getFlage());
